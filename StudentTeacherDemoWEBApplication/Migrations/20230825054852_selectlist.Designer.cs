...
namespace StudentTeacherDemoWEBApplication.Migrations
{
    ...
    [Migration("20230825054852_selectlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraduationPostGraduation", b =>
                {
                    b.Property<int>("PostGraduationsPostID")
                        .HasColumnType("int");

                    b.Property<int>("graduationGradID")
                        .HasColumnType("int");

                    b.HasKey("PostGraduationsPostID", "graduationGradID");

                    b.HasIndex("graduationGradID");

                    b.ToTable("GraduationPostGraduation");
                });

            modelBuilder.Entity("StudentTeacherDemoWEBApplication.Models.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentTeacherDemoWEBApplication.Models.Product", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraduationPostGraduation", b =>
                {
                    b.HasOne("StudentTeacherDemoWEBApplication.Models.PostGraduation", null)
                        .WithMany()
                        .HasForeignKey("PostGraduationsPostID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudentTeacherDemoWEBApplication.Models.Graduation", null)
                        .WithMany()
                        .HasForeignKey("graduationGradID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("StudentTeacherDemoWEBApplication.Models.Product", b =>
                {
                    b.HasOne("StudentTeacherDemoWEBApplication.Models.Category", "category")
                        .WithMany()
